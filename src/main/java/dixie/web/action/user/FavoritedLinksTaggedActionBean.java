 ...
 * @author jferland
 */
@UrlBinding("/user/{user}/favorite/{format=all}/tagged/{tags}/page{page.index}")
public class FavoritedLinksTaggedActionBean extends FavoritedLinksActionBean
{
	...
	{
		return getLinks(format, tags, user, UserLinkRelation.FAVORITED);
	}

	@Override
	public DaoPage<Tag> getRelatedTags()
	{
		return getRelatedTags(format, tags, user, UserLinkRelation.FAVORITED);
	}
}