 ...
 * @author jferland
 */
@UrlBinding("/user/{user}/favorites/{format=all}/page{page.index}")
public class FavoritedLinksActionBean extends UserLinksActionBean
{
	private static final String VIEW = "/WEB-INF/ftl/user/favorites.ftl";
